...
export default function AdminLayout({ children }) {
  ...
  // Dropdown states
  const [historyOpen, setHistoryOpen] = useState(isActive('/dashboard/admin/history') || isActive('/dashboard/admin/user-history'));
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <aside className="w-64 bg-white dark:bg-[#1e293b] border-r border-gray-200 dark:border-slate-800 flex flex-col overflow-y-auto shrink-0 z-10 transition-colors duration-300">
          ...
          <nav className="flex-1 px-4 py-6 space-y-1">
            ...
            <div className="space-y-1">
              <div className={`flex items-center justify-between pr-1 rounded-lg transition-colors ${(isActive('/dashboard/admin/history') || isActive('/dashboard/admin/user-history')) ? 'bg-primary/5 dark:bg-primary/20 text-primary dark:text-white' : 'text-slate-600 dark:text-slate-400 hover:bg-gray-50 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-white'}`}>
                <Link 
        ...
        <main className="flex-1 overflow-y-auto p-6 lg:p-8">
          ...
          <footer className="mt-8 flex items-center justify-between text-[11px] text-gray-400 dark:text-slate-500 border-t border-gray-200 dark:border-slate-800 pt-4">
             <p>&copy; 2026 Design By <a href="https://www.gimhan.me" target="_blank" rel="noopener noreferrer" className="text-slate-600 dark:text-slate-400 font-bold hover:text-blue-600 dark:hover:text-blue-400 transition-colors">GDThemes</a></p>
          </footer>
        </main>
      </div>
    </div>
