    ...
    <div className="max-w-5xl space-y-6">
      ...
      <section className="bg-white dark:bg-[#1e293b] rounded-lg border border-gray-200 dark:border-slate-800 shadow-sm p-6">
        ...
        <form onSubmit={saveTimetable} className="grid lg:grid-cols-3 gap-4 mb-8">
          ...
          <input type="number" value={timetableForm.sortOrder} onChange={(event) => updateTimetableField("sortOrder", event.target.value)} placeholder="Order" className="rounded-lg border border-gray-200 dark:border-slate-800 px-3 py-2.5 text-sm outline-none focus:border-primary dark:bg-[#0f172a]" />
