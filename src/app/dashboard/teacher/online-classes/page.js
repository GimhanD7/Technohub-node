...
import {
  Plus, Trash2, Calendar, Video, RefreshCw, Search, BarChart3, Zap, Clock, Archive, Loader2, Filter
} from "lucide-react";
    ...
    <div className="max-w-7xl mx-auto space-y-6 relative pb-12">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-2">
        <div>
          ...
          <p className="text-[13px] text-gray-500 dark:text-gray-400 mt-1">Schedule live online classes for your students</p>
        </div>
      ...
      {/* Notice Banner */}
      <div className="p-3 bg-amber-50/50 dark:bg-amber-900/10 border border-amber-200 dark:border-amber-800/30 rounded text-amber-800 dark:text-amber-400 text-[12px] flex gap-2 items-center">
        <span className="font-bold">Notice:</span> You can schedule and delete classes. Only administrators can edit published sessions.
      </div>
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-white dark:bg-[#1e293b] border-b border-gray-200 dark:border-slate-800 text-[10px] uppercase tracking-wider text-gray-500 dark:text-white sticky top-0 z-10">
                ...
                <th className="py-3 px-5 font-bold hidden lg:table-cell">Duration</th>
                ...
                filteredClasses.map(cls => {
                  ...
                  return (
                    <tr key={cls.id} className="hover:bg-gray-50/50 dark:hover:bg-slate-800/50 transition-colors">
                      ...
                      <td className="py-3 px-5 hidden lg:table-cell text-gray-600 dark:text-gray-300">
                        {cls.duration} min
                      </td>
                      <td className="py-3 px-5">
