...
with open('src/app/dashboard/teacher/e-books/page.js', 'r') as f:
    code = f.read()
...
code = code.replace('''      <div className="mb-8">
        ...
        <p className="text-slate-500 dark:text-white">Add and manage your digital learning materials for students.</p>
      </div>''', refresh_html)
...
with open('src/app/dashboard/teacher/e-books/page.js', 'w') as f:
    f.write(code)
